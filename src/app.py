...
activities = {
    "Baseball Team": {
        "description": "Join our competitive baseball team and compete in local leagues",
    ...
    "Art Studio": {
        "description": "Explore various art mediums including painting, sculpture, and drawing",
    ...
    "Debate Team": {
        ...
        "max_participants": 20,
        "participants": ["robert@mergington.edu", "emily@mergington.edu"]
        },
    "Science Club": {
...
# TESTING ONLY: Reset activities state
@app.post("/test/reset-activities")
def reset_activities_endpoint(request: Request):
    """Reset the activities state to its initial values (for testing only)"""
    global activities
    activities = {
        "Baseball Team": {
            "description": "Join our competitive baseball team and compete in local leagues",
    ...
    return {"message": "Activities state reset"}
